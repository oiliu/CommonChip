...
namespace CommonPublic
{
    ...
    /// </summary>
    //调用方法
    //private string iniFilePath = Path.Combine(Environment.CurrentDirectory, @"Config.ini"); //Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"RigourTech\ScreenConfig\Config");
    //return IniFileHelper.GetValue("RealVideoConfig", "RoundToRealVideoDiffTime", iniFilePath);
